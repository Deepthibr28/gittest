...
//		action.clickAndHold(fromElement1).moveToElement(toElement1).release().perform();
//		action.dragAndDrop(fromElement1, toElement1).perform();
//		action.moveToElement(toElement, xOffset, yOffset).perform();
